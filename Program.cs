...
builder.Services.AddCors(options => options.AddPolicy("FrontendCors", builder => _ = builder.WithOrigins("https://localhost:4200", "https://127.0.0.1:4200").AllowAnyHeader().AllowAnyMethod()));
