...
namespace AsistenciaBack.Migrations
{
    ...
    [Migration("20220508042430_ClaseDto")]
    partial class ClaseDto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsistenciaBack.Model.Clase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AsistenciaBack.Model.Clase", b =>
                {
                    b.HasOne("AsistenciaBack.Model.Curso", "Curso")
                        .WithMany("Clases")
            ...
            modelBuilder.Entity("CursoUser", b =>
                {
                    b.HasOne("AsistenciaBack.Model.Curso", null)
                        .WithMany()
